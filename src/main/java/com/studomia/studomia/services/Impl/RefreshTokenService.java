...
public class RefreshTokenService {
    ...
    public RefreshToken createRefreshToken() {
        ...
        refreshToken.setCreatedAt(formattedDate);
        refreshToken.setUpdatedAt(formattedDate);
