...
import com.studomia.studomia.exceptions.ResourceAlreadyInUseException;
...
import com.studomia.studomia.services.Impl.RefreshTokenService;
import com.studomia.studomia.services.Impl.UserDeviceService;
import com.studomia.studomia.services.Impl.UserService;
...
public class AuthService {
   ...
   // private final PasswordResetTokenService passwordResetTokenService;
    ...
    public AuthService(UserService userService, JwtTokenProvider tokenProvider,RefreshTokenService refreshTokenService,
                       ...
                       UserDeviceService userDeviceService)     //EmailVerificationTokenService emailVerificationTokenService,
     ...
     */
    public Optional<User> registerUser(RegistrationRequest newRegistrationRequest,User user) {
        ...
        User newUser = userService.createUser(newRegistrationRequest,user);
     ...
     */
    public Optional<Authentication> authenticateUser(Login loginRequest) {
...
//    }
     ...
     */
    public String generateToken(UserPrincipal customUserDetails) {
     ...
     */
    public Optional<RefreshToken> createAndPersistRefreshTokenForDevice(Authentication authentication, Login loginRequest) {
        User currentUser = (User) ((UserPrincipal)authentication.getPrincipal()).getUser();
        //if successful login -> remove old refresh token
//        userDeviceService.f(currentUser.getEmail())
...
//        userDevice.setCreatedAt(instant1);
//        userDevice.setUpdatedAt(instant1);
...
//        refreshToken = refreshTokenService.save(refreshToken);
        ...
        return  Optional.of(null);// Optional.ofNullable(refreshToken);
    }
